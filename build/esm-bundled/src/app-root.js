...
<g id="place"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"></path></g>
  ...
  <svg>
   ...
   <style>
    ...
    `}constructor(){super();this._openToast=this._openToast.bind(this)}ready(){super.ready();this.paddingTop=this.$.header.offsetHeight}static get properties(){return{page:{type:String,reflectToAttribute:!0,observer:"_pageChanged"},hello:String,routeData:Object,subroute:Object,routePath:Object}}static get observers(){return["_routePageChanged(routeData.page)"]}_routePageChanged(page){if(!page)this.page="landing";else if(-1!==["landing","form"].indexOf(page))this.page=page;else{this.page="landing";this.set("routeData","/")}}_pageChanged(page){switch(page){case"landing":this.hidden=!1;break;case"form":this.hidden=!0;break;default:this.hidden=!1;break;}}_openToast(message){this.message=message;this.$.toast.open()}}window.customElements.define("app-root",AppRoot);export{appLayoutBehavior as $appLayoutBehavior,appScrollEffectsBehavior as $appScrollEffectsBehavior,helpers as $helpers,appRouteConverterBehavior as $appRouteConverterBehavior,ironA11yAnnouncer as $ironA11yAnnouncer,ironA11yKeysBehavior as $ironA11yKeysBehavior,ironButtonState as $ironButtonState,ironControlState as $ironControlState,ironCheckedElementBehavior as $ironCheckedElementBehavior,ironFitBehavior as $ironFitBehavior,ironFormElementBehavior as $ironFormElementBehavior,ironJsonpLibrary as $ironJsonpLibrary,ironMenuBehavior as $ironMenuBehavior,ironMeta as $ironMeta,ironFocusablesHelper as $ironFocusablesHelper,ironOverlayBehavior as $ironOverlayBehavior,ironOverlayManager as $ironOverlayManager,ironScrollManager as $ironScrollManager,ironResizableBehavior as $ironResizableBehavior,ironScrollTargetBehavior as $ironScrollTargetBehavior,ironMultiSelectable as $ironMultiSelectable,ironSelectable as $ironSelectable,ironSelection as $ironSelection,ironValidatableBehavior as $ironValidatableBehavior,neonAnimatableBehavior as $neonAnimatableBehavior,neonAnimationBehavior as $neonAnimationBehavior,neonAnimationRunnerBehavior as $neonAnimationRunnerBehavior,paperButtonBehavior as $paperButtonBehavior,paperCheckedElementBehavior as $paperCheckedElementBehavior,paperInkyFocusBehavior as $paperInkyFocusBehavior,paperRippleBehavior as $paperRippleBehavior,paperDialogBehavior as $paperDialogBehavior,paperInputAddonBehavior as $paperInputAddonBehavior,paperInputBehavior as $paperInputBehavior,paperItemBehavior as $paperItemBehavior,paperSpinnerBehavior as $paperSpinnerBehavior,arraySelector as $arraySelector,customStyle as $customStyle,domBind as $domBind,domIf as $domIf,domModule as $domModule,domRepeat as $domRepeat,_class as $class,legacyElementMixin as $legacyElementMixin,mutableDataBehavior as $mutableDataBehavior,polymerFn as $polymerFn,polymer_dom as $polymerDom,templatizerBehavior as $templatizerBehavior,dirMixin as $dirMixin,elementMixin as $elementMixin,gestureEventListeners as $gestureEventListeners,mutableData as $mutableData,propertiesChanged as $propertiesChanged,propertiesMixin as $propertiesMixin,propertyAccessors as $propertyAccessors,propertyEffects as $propertyEffects,templateStamp as $templateStamp,arraySplice as $arraySplice,async as $async,caseMap$1 as $caseMap,debounce as $debounce,flattenedNodesObserver as $flattenedNodesObserver,flush$2 as $flush,gestures$0 as $gestures,htmlTag as $htmlTag,mixin as $mixin,path as $path,renderStatus as $renderStatus,resolveUrl$1 as $resolveUrl,settings as $settings,styleGather as $styleGather,templatize$1 as $templatize,polymerElement as $polymerElement,polymerLegacy as $polymerLegacy,applyShimUtils as $applyShimUtils,applyShim as $applyShim$1,commonRegex as $commonRegex,commonUtils as $commonUtils,cssParse as $cssParse,customStyleInterface as $customStyleInterface$1,documentWait$1 as $documentWait,styleSettings as $styleSettings,styleUtil as $styleUtil,templateMap$1 as $templateMap,unscopedStyleHandler as $unscopedStyleHandler,checkOverflow$1 as $checkOverflow,dateFromArray as $dateFromArray,fromAnything as $fromAnything,fromArray as $fromArray,fromObject as $fromObject,fromStringAndArray as $fromStringAndArray,fromStringAndFormat as $fromStringAndFormat,fromString as $fromString,local as $local,parsingFlags as $parsingFlags,utc as $utc,valid as $valid,abs$1 as $abs,addSubtract$3 as $addSubtract,as$1 as $as,bubble$1 as $bubble,clone$1 as $clone,constructor$2 as $constructor,create as $create,duration as $duration,get$3 as $get,humanize$1 as $humanize,isoString as $isoString,valid$1 as $valid$1,format as $format,baseConfig$1 as $baseConfig,calendar$1 as $calendar,constructor$1 as $constructor$1,formats as $formats,invalid as $invalid,lists as $lists,locale$2 as $locale,locales$1 as $locales,ordinal$1 as $ordinal,prePostFormat as $prePostFormat,relative as $relative,set$3 as $set,addSubtract$1 as $addSubtract$1,calendar$3 as $calendar$1,clone$3 as $clone$1,compare as $compare,constructor as $constructor$2,creationData$1 as $creationData,diff$1 as $diff,format$2 as $format$1,from$1 as $from,getSet as $getSet,locale$1 as $locale$1,minMax as $minMax,moment as $moment,now$1 as $now,prototype as $prototype$2,startEndOf as $startEndOf,toType as $toType,to$1 as $to,valid$2 as $valid$2,regex as $regex,token as $token,aliases$1 as $aliases,constants as $constants,dayOfMonth as $dayOfMonth,dayOfWeek as $dayOfWeek,dayOfYear as $dayOfYear,hour as $hour,millisecond as $millisecond,minute as $minute,month as $month,offset$1 as $offset,priorities$1 as $priorities,quarter as $quarter,second as $second,timezone as $timezone,units as $units,weekCalendarUtils as $weekCalendarUtils,weekYear as $weekYear,week as $week,year as $year,absCeil$1 as $absCeil,absFloor$1 as $absFloor,absRound$1 as $absRound,compareArrays$1 as $compareArrays,defaults$1 as $defaults,deprecate$1 as $deprecate,extend$1 as $extend,hasOwnProp$1 as $hasOwnProp,hooks$1 as $hooks,indexOf$1 as $indexOf,isArray$1 as $isArray,isDate$1 as $isDate,isFunction$1 as $isFunction,isNumber$1 as $isNumber,isObjectEmpty$1 as $isObjectEmpty,isObject$1 as $isObject,isUndefined$1 as $isUndefined,keys$1 as $keys,map$1 as $map,mod$1 as $mod,some$1 as $some,toInt$1 as $toInt,zeroFill$1 as $zeroFill,moment$1 as $moment$1,AppLayoutBehavior,AppScrollEffectsBehavior,_scrollEffects,_scrollTimer,scrollTimingFunction,registerEffect,queryAllRoot,scroll,AppRouteConverterBehavior,IronA11yAnnouncer,IronA11yKeysBehavior,IronButtonStateImpl,IronButtonState,IronControlState,IronCheckedElementBehaviorImpl,IronCheckedElementBehavior,IronFitBehavior,IronFormElementBehavior,IronJsonpLibraryBehavior,IronMenuBehaviorImpl,IronMenuBehavior,IronMeta,IronFocusablesHelper,IronOverlayBehaviorImpl,IronOverlayBehavior,IronOverlayManagerClass,IronOverlayManager,currentLockingElement,elementIsScrollLocked,pushScrollLock,removeScrollLock,_lockingElements,_lockedElementCache,_unlockedElementCache,_hasCachedLockedElement,_hasCachedUnlockedElement,_composedTreeContains,_scrollInteractionHandler,_boundScrollHandler,_lockScrollInteractions,_unlockScrollInteractions,_shouldPreventScrolling,_getScrollableNodes,_getScrollingNode,_getScrollInfo,IronResizableBehavior,IronScrollTargetBehavior,IronMultiSelectableBehaviorImpl,IronMultiSelectableBehavior,IronSelectableBehavior,IronSelection,IronValidatableBehaviorMeta,IronValidatableBehavior,NeonAnimatableBehavior,NeonAnimationBehavior,NeonAnimationRunnerBehaviorImpl,NeonAnimationRunnerBehavior,PaperButtonBehaviorImpl,PaperButtonBehavior,PaperCheckedElementBehaviorImpl,PaperCheckedElementBehavior,PaperInkyFocusBehaviorImpl,PaperInkyFocusBehavior,PaperRippleBehavior,PaperDialogBehaviorImpl,PaperDialogBehavior,PaperInputAddonBehavior,PaperInputHelper,PaperInputBehaviorImpl,PaperInputBehavior,PaperItemBehaviorImpl,PaperItemBehavior,PaperSpinnerBehavior,ArraySelectorMixin,ArraySelector,CustomStyle,DomBind,DomIf,DomModule,DomRepeat,mixinBehaviors,Class,LegacyElementMixin,MutableDataBehavior,OptionalMutableDataBehavior,Polymer$1 as Polymer,matchesSelector,DomApi,dom,flush$1 as flush,enqueueDebouncer as addDebouncer,Templatizer,DirMixin,ElementMixin,instanceCount,registrations,register,dumpRegistrations,updateStyles,GestureEventListeners,MutableData,OptionalMutableData,PropertiesChanged,PropertiesMixin,PropertyAccessors,PropertyEffects,TemplateStamp,calculateSplices,timeOut,animationFrame,idlePeriod,microTask,dashToCamelCase,camelToDashCase,Debouncer,FlattenedNodesObserver,enqueueDebouncer,flush$1,gestures,recognizers,deepTargetFind,addListener,removeListener,register$1,setTouchAction,prevent,resetMouseCanceller,findOriginalTarget,add,remove,html,htmlLiteral,dedupingMixin,isPath,root,isAncestor,isDescendant,translate,matches,normalize,split,get,set,isDeep,beforeNextRender,afterNextRender,flush as flush$2,resolveUrl,resolveCss,pathFromUrl,useShadow,useNativeCSSProperties,useNativeCustomElements,rootPath,setRootPath,sanitizeDOMValue,setSanitizeDOMValue,passiveTouchGestures,setPassiveTouchGestures,stylesFromModules,stylesFromModule,stylesFromTemplate,stylesFromModuleImports,cssFromModules,cssFromModule,cssFromTemplate,cssFromModuleImports,templatize,modelForElement,TemplateInstanceBase,html as html$1,PolymerElement,Polymer$1,html as html$2,Base,invalidate,invalidateTemplate,isValid,templateIsValid,isValidating,templateIsValidating,startValidating,startValidatingTemplate,elementsAreInvalid,ApplyShim as $applyShimDefault,VAR_ASSIGN,MIXIN_MATCH,VAR_CONSUMED,ANIMATION_MATCH,MEDIA_MATCH,IS_VAR,BRACKETED,HOST_PREFIX,HOST_SUFFIX,updateNativeProperties,getComputedStyleValue,detectMixin,StyleNode,parse,stringify,removeCustomPropAssignment,types,CustomStyleProvider,CustomStyleInterface as $customStyleInterfaceDefault,CustomStyleInterfaceInterface,documentWait as $documentWaitDefault,nativeShadow,nativeCssVariables,toCssText,rulesForStyle,isKeyframesSelector,forEachRule,applyCss,createScopeStyle,applyStylePlaceHolder,applyStyle,isTargetedBuild,getCssBuildType,processVariableAndFallback,setElementClassRaw,getIsExtends,gatherStyleText,templateMap as $templateMapDefault,scopingAttribute,processUnscopedStyle,isUnscopedStyle,checkOverflow as $checkOverflowDefault,createDate,createUTCDate,prepareConfig,createLocalOrUTC,configFromArray,configFromObject,configFromStringAndArray,configFromStringAndFormat,configFromISO,configFromRFC2822,configFromString,createLocal,getParsingFlags as $parsingFlagsDefault,createUTC,isValid$1,createInvalid,abs,add$2 as add$1,subtract$1 as subtract,as,valueOf,asMilliseconds,asSeconds,asMinutes,asHours,asDays,asWeeks,asMonths,asYears,bubble,daysToMonths,monthsToDays,clone,Duration,isDuration,createDuration,createDuration as createDuration$1,isDuration as isDuration$1,getSetRelativeTimeRounding,getSetRelativeTimeThreshold,get$2 as get$1,milliseconds,seconds,minutes,hours,days,months,years,weeks,getSetRelativeTimeRounding as getSetRelativeTimeRounding$1,getSetRelativeTimeThreshold as getSetRelativeTimeThreshold$1,humanize,toISOString,isDurationValid as $validDefault,isValid$2,createInvalid$1,formattingTokens,formatTokenFunctions,addFormatToken,formatMoment,expandFormat,baseConfig,defaultCalendar,calendar,Locale,defaultLongDateFormat,longDateFormat,defaultInvalidDate,invalidDate,listMonths,listMonthsShort,listWeekdays,listWeekdaysShort,listWeekdaysMin,getSetGlobalLocale,defineLocale,updateLocale,getLocale,listLocales,listMonths as listMonths$1,listMonthsShort as listMonthsShort$1,listWeekdays as listWeekdays$1,listWeekdaysShort as listWeekdaysShort$1,listWeekdaysMin as listWeekdaysMin$1,getSetGlobalLocale as getSetGlobalLocale$1,defineLocale as defineLocale$1,updateLocale as updateLocale$1,getLocale as getLocale$1,listLocales as listLocales$1,defaultOrdinal,defaultDayOfMonthOrdinalParse,ordinal,preParsePostFormat,defaultRelativeTime,relativeTime,pastFuture,set$2 as set$1,mergeConfigs,addSubtract,add$1 as add$2,subtract as subtract$1,getCalendarFormat,calendar$2 as calendar$1,clone$2 as clone$1,isAfter,isBefore,isBetween,isSame,isSameOrAfter,isSameOrBefore,copyConfig,Moment,isMoment,creationData,diff,toString,toISOString$1,inspect,format$1 as format,from,fromNow,makeGetSet,get$1 as get$2,set$1 as set$2,stringGet,stringSet,locale,lang,localeData,prototypeMin,prototypeMax,min,max,now,min as min$1,max as max$1,isMoment as isMoment$1,createUTC as createUTC$1,createUnix,createLocal as createLocal$1,createInZone,createInvalid as createInvalid$2,proto$3 as momentPrototype,now as now$1,proto$3 as $prototypeDefault,startOf,endOf,valueOf$1,unix,toDate,toArray,toObject,toJSON,to,toNow,isValid$3,parsingFlags$1 as parsingFlags,invalidAt,match1,match2,match3,match4,match6,match1to2,match3to4,match5to6,match1to3,match1to4,match1to6,matchUnsigned,matchSigned,matchOffset,matchShortOffset,matchTimestamp,matchWord,addRegexToken,getParseRegexForToken,regexEscape,addParseToken,addWeekParseToken,addTimeToArrayFromToken,addUnitAlias,normalizeUnits,normalizeObjectUnits,YEAR,MONTH,DATE,HOUR,MINUTE,SECOND,MILLISECOND,WEEK,WEEKDAY,getSetDayOfMonth,defaultLocaleWeekdays,localeWeekdays,defaultLocaleWeekdaysShort,localeWeekdaysShort,defaultLocaleWeekdaysMin,localeWeekdaysMin,localeWeekdaysParse,getSetDayOfWeek,getSetLocaleDayOfWeek,getSetISODayOfWeek,weekdaysRegex,weekdaysShortRegex,weekdaysMinRegex,getSetDayOfYear,localeIsPM,defaultLocaleMeridiemParse,localeMeridiem,getSetHour,getSetMillisecond,getSetMinute,daysInMonth,defaultLocaleMonths,localeMonths,defaultLocaleMonthsShort,localeMonthsShort,localeMonthsParse,setMonth,getSetMonth,getDaysInMonth,monthsShortRegex,monthsRegex,cloneWithOffset,getSetOffset,getSetZone,setOffsetToUTC,setOffsetToLocal,setOffsetToParsedOffset,hasAlignedHourOffset,isDaylightSavingTime,isDaylightSavingTimeShifted,isLocal,isUtcOffset,isUtc,addUnitPriority,getPrioritizedUnits,getSetQuarter,getSetSecond,getZoneAbbr,getZoneName,normalizeUnits as normalizeUnits$1,dayOfYearFromWeeks,weekOfYear,weeksInYear,getSetWeekYear,getSetISOWeekYear,getISOWeeksInYear,getWeeksInYear,localeWeek,defaultLocaleWeek,localeFirstDayOfWeek,localeFirstDayOfYear,getSetWeek,getSetISOWeek,daysInYear,isLeapYear,getSetYear,getIsLeapYear,absCeil as $absCeilDefault,absFloor as $absFloorDefault,absRound as $absRoundDefault,compareArrays as $compareArraysDefault,defaults as $defaultsDefault,deprecate,deprecateSimple,extend as $extendDefault,hasOwnProp as $hasOwnPropDefault,hooks,setHookCallback,indexOf as $indexOfDefault,isArray as $isArrayDefault,isDate as $isDateDefault,isFunction as $isFunctionDefault,isNumber as $isNumberDefault,isObjectEmpty as $isObjectEmptyDefault,isObject as $isObjectDefault,isUndefined as $isUndefinedDefault,keys as $keysDefault,map as $mapDefault,mod as $modDefault,some as $someDefault,toInt as $toIntDefault,zeroFill as $zeroFillDefault,hooks as $momentDefault};